...
The goal of this one is to create a server and a client in order to be able to send messages from the client to the server thanks to the signals "SIGUSR1" and "SIGUSR2".
